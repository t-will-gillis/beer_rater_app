...
review1 = Review(id = 1, location = 'Bar/ Restaurant', container = 'Bottle', size = '12 oz', overall = 4.5, look = 0.0, smell = 0.0, taste = 0.0, feel = 0.0, notes = 'Another great one from Societe', beer_id = 1, user_id = 1)
